...
const BlockRenderer = ({ block, index, updateBlockContent, removeContentBlock, moveBlock, isProcessing, contentBlocks, openFileManager }: { 
    ...
    const handleFileChange = (
        ...
        if (e.target.files) {
          ...
          // Get existing files that are not string URLs
...
export default function NewStoryPage() {
  ...
  const onSubmit = async (values: z.infer<typeof storySchema>) => {
    ...
    try {
      ...
      toast({ title: "Finalisasi...", description: "Menyimpan cerita lengkap ke database." });
      ...
      if (result.success) {
        toast({ title: "Cerita Dibuat!", description: "Cerita baru Anda telah berhasil dibuat." });
        router.push("/admin/dashboard");
      } else {
        throw new Error(result.message || "Gagal menyimpan cerita.");
      }
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Isi detail utama untuk cerita baru Anda.</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                    ...
                    <CardDescription>Tambah dan atur blok konten untuk membangun halaman cerita Anda.</CardDescription>
                </CardHeader>
            ...
            <div className="space-y-8">
              <Card>
                <CardHeader><CardTitle>Gambar Hero</CardTitle><CardDescription>Gambar utama untuk cerita Anda.</CardDescription></CardHeader>
                <CardContent className="space-y-4">
              ...
              <Card>
                <CardHeader><CardTitle>Cerita Audio</CardTitle><CardDescription>Unggah file audio opsional.</CardDescription></CardHeader>
                <CardContent className="space-y-4">
