          ...
          <SheetContent side="left" className="flex flex-col bg-slate-900 text-white border-slate-800 w-[280px] sm:max-w-[280px]">
            ...
            <nav className="grid gap-1 text-base font-medium">
              ...
              <Link
                ...
                className={cn("mx-[-0.65rem] flex items-center gap-3 rounded-md px-3 py-2", isLinkActive('/admin/dashboard') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white')}
              >
              ...
              <Link
                href="/admin/inbox"
                className={cn("mx-[-0.65rem] flex items-center gap-3 rounded-md px-3 py-2", isLinkActive('/admin/inbox') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white')}
              >
              ...
              <Link
                ...
                className={cn("mx-[-0.65rem] flex items-center gap-3 rounded-md px-3 py-2", isLinkActive('/admin/stories/new') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white')}
              >
               ...
               <Link
                ...
                className={cn("mx-[-0.65rem] flex items-center gap-3 rounded-md px-3 py-2", isLinkActive('/admin/file-manager') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white')}
              >
              ...
              <Link
                href="/admin/invoice"
                className={cn("mx-[-0.65rem] flex items-center gap-3 rounded-md px-3 py-2", isLinkActive('/admin/invoice') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white')}
              >
              ...
              <Link
                href="/admin/checkout"
                className={cn("mx-[-0.65rem] flex items-center gap-3 rounded-md px-3 py-2", isLinkActive('/admin/checkout') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white')}
              >
               ...
               <Accordion type="single" collapsible className="w-full" defaultValue={pathname.startsWith('/admin/settings') ? 'settings' : ''}>
                <AccordionItem value="settings" className="border-b-0">
                  <AccordionTrigger className={cn("mx-[-0.65rem] flex items-center gap-3 rounded-md px-3 py-2 text-slate-400 hover:text-white hover:no-underline [&[data-state=open]>svg]:text-white", pathname.startsWith('/admin/settings') && 'text-white')}>
            ...
            <div className="mt-auto">
                <Button variant="ghost" onClick={handleLogout} className="w-full justify-start gap-3 px-3 py-2 text-slate-400 hover:text-white hover:bg-slate-800">
